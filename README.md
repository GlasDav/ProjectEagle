...
- Solaris Core Australian Equity Fund is sourced from Solaris' public page tables for unit prices and distributions. The public unit-price table is sparse before September 2025, so the scraper also uses Solaris' published net performance table to add 1Y, 3Y, and 5Y calibration anchors.
